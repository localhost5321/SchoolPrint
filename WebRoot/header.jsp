		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li id="navBarDocCenter"><a href="javascript:alert('程序猿正在加班工作中...')">文档中心</a></li>
					<li id="navBarAbout"><a href="" data-toggle="modal" data-target="#aboutUs">关于</a>
					<li id="navBarNote"><a href="" >留言</a>
					</li>
				</ul>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form"
					action="userLogin.action" method="post" id="loginForm">
	...
	<div class="modal fade" id="registerModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!--注册表单-->
				<form class="form-horizontal" role="form"
					action="userRegist.action" method="post" id="registForm">
					<div class="modal-body">
						<!--输入用户名-->
						<div class="form-group">
